...
console.log(emtr);
emtr.emit('jump');
//Explicacion: En la funcion emit se busca que haya alguna propiedad con un nombre llamado "jump", si es que existe con un forEach recorres todos los elementos que tenga el array de dicha propiedad y ejecuta cada elemento del array como una funcion